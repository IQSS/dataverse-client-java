...
/**
 * Base class of SearchHits returned in the <code>items</code> field of a search result.
 * @author rspace
 *
 */
// used to deserialise Json into correct subclasses using value of 'type' property
@JsonTypeInfo(
