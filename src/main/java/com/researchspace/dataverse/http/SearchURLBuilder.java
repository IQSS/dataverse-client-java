...
/**
 * URL builder for SearchOperationsImplV1.
 */
class SearchURLBuilder {
    String buildSearchUrl(String path, final SearchConfig cfg) {

        final UriComponentsBuilder urlBuilder = UriComponentsBuilder.fromUriString(path).queryParam("q", cfg.getQ());
        final EnumSet<SearchType> types = cfg.getType();
